...
<!--                            <li class="bullet success">Your version of PHP is 7.4.0 or higher (detected --><?php //= PHP_VERSION ?><!--).</li>-->
<!--                        --><?php //else : ?>
<!--                            <li class="bullet problem">Your version of PHP is too low. You need PHP 7.4.0 or higher to use CakePHP (detected --><?php //= PHP_VERSION ?><!--).</li>-->
<!--                        --><?php //endif; ?>
<!---->
...
<!--                            <li class="bullet success">The <em>--><?php //= h($settings['className']) ?><!--</em> is being used for core caching. To change the config edit config/app.php</li>-->
<!--                        --><?php //else : ?>
...
<!--                        --><?php //else : ?>
<!--                            <li class="bullet problem">CakePHP is NOT able to connect to the database.<br />--><?php //= h($result['error']) ?><!--</li>-->
<!--                        --><?php //endif; ?>
<!--                        </ul>-->
<!--                    </div>-->
<!--                    <div class="column">-->
...
<!--                            --><?php //else : ?>
<!--                                <li class="bullet problem">There are configuration problems present which need to be fixed:<br />--><?php //= $result['error'] ?><!--</li>-->
<!--                            --><?php //endif; ?>
<!--                        --><?php //else : ?>
